...
<script type="text/javascript">
	...
	function shareAct(a) {
		...
		case "vIconNb":
			//네이버블로그
			cUrl = "https://share.naver.com/web/shareView.nhn?url=" + cUrl
					+ "&title=" + "test";
			break;
		...
		<article class="col-md-8">
				<div class="newsView">
					<div class="titleSection" style="padding: 5px;" >
						...
						<div style="float: left;">&nbsp;&nbsp;조회수 ${dto.hit }</div>
												...
												<div class="shareIcon" style="float: right;">
							<i onclick="toggleSNSIcon();" class='fas fa-share-square'
								style='font-size: 25px; margin-left: 10px;'></i>
							<ul id="snsList" class="snsList" style="display: none;">
								<li>SNS 공유하기</li>
								<!-- sns사진넣기---------------------------------------------------------- -->
								<li><a href="#" id="vIconTw" onclick="return false;"><i
										class="vIconTw">트위터</i></a></li>
								<li><a href="#" id="vIconTg" onclick="return false;"><i
										class="vIconTg">텔레그램</i></a></li>
								<li><a href="#" id="vIconFb" onclick="return false;"><i
										class="vIconFb">페이스북</i></a></li>
								<li><a href="#" id="vIconKs" onclick="return false;"><i
										class="vIconKs">카카오톡</i></a></li>
								<li><a href="#" id="vIconNb" onclick="return false;"><i
										class="vIconNb">네이버블로그</i></a></li>
							</ul>
						</div>
						
						<div class="print" onclick="window.print()" style="float: right; padding-left: 10px;">
							<i class="fa fa-print" style="font-size: 25px;"></i>
						</div>
						
						<div style="float: right;">
							<i class='far fa-comment-dots' style='font-size: 25px; padding-left: 10px;'></i>
							<p class=rep_cnt_main style="float: right; font-weight: bold;">${dto.rep_cnt }</p>
						</div>

						
					</div>
					<div class="bodySection" style="clear: both; border-top: 1px solid #B2BABB;">
					<div style="margin-top: 70px;">${dto.content }</div>
					</div>
				</div>
				<!--댓글 ---------------------------------------------------- -->
				<div class="row bootstrap snippets" style="padding-top: 15px;">
					<div>
						<div class="comment-wrapper">
							<div class="panel panel-info">
								<div class="panel-heading">댓글 ${dto.rep_cnt }개</div>
								<div class="panel-body">
									...
									<form name="commentInsertForm">
										...
										<button type="button" id="signinBtn"
											class="btn btn-info pull-right" name="signinBtn"
			...
			<nav>
				...
				<div class="newsB">
					...
					<div class="search">
						<form action="list.do" class="searchForm" id="searchForm"
							name="searchForm">
							<input type="text" name="word" id="newsSearchWord"
								class="searchTerm" placeholder="검색어를 입력하세요."
							...
							<c:choose>
								<c:when test="${fn:length(mostViewed.title)>23}">
									<div class="mostViewedTitles">
										<a href="view.do?nno=${mostViewed.nno}&cnt=1"> <c:out
